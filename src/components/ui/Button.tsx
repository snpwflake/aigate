...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary:
        "bg-primary-600 text-white hover:bg-primary-700 focus:ring-primary-500 hover:-translate-y-0.5 shadow-lg hover:shadow-xl",
      secondary:
        "bg-transparent text-primary-600 border-2 border-primary-600 hover:bg-primary-600 hover:text-white hover:-translate-y-0.5",
      outline:
